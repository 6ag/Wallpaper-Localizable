...
class JFSideView: UIView {
    ...
    @IBOutlet weak var myCollectButton: JFSideButton!
    @IBOutlet weak var cleanupButton: JFSideButton!
    @IBOutlet weak var feedbackButton: JFSideButton!
    
    override func awakeFromNib() {
        super.awakeFromNib()
        myCollectButton.setTitle(NSLocalizedString("myCollection", comment: ""), forState: .Normal)
        cleanupButton.setTitle(NSLocalizedString("cluanupCache", comment: ""), forState: .Normal)
        feedbackButton.setTitle(NSLocalizedString("feedback", comment: ""), forState: .Normal)
    }
